...
<head>
    ...
    table {
        /* Fix table width issues in PDF */
        width: 100% !important;
        page-break-inside: auto;
    }
    
    /* More specific layout adjustments for PDF */
    ...
    <div class="invoice-container">
        ...
        <div class="row invoice-details">
            ...
            <div class="col-6 text-end">
                ...
                <span
                    class="status-badge status-{{ strtolower(str_replace('_', '-', $transaksi->status_pembayaran)) }}">
        ...
        <div class="table-items">
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    @php
                        $items = is_string($transaksi->items)
